      ...
      <section className="h-full wi-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center relative md:mt-[-70px]">
          <Image
            ...
            height={1200}
            width={1200}
            className="rounded-tl-2xl rounded-tr-2xl border-2 boder-muted"
          />
          ...
          {prices.data.map((card) => (
            ...
            >
              <CardHeader>
                <CardTitle
                  className={clsx("", {
                    "text-muted-foreground": card.nickname !== "Unlimted Saas",
                  })}
                >
                  {card.nickname}
                </CardTitle>
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                <div>
                  {pricingCards.find((c)=>c.title===card.nickname)?.features.map((feature) => (
